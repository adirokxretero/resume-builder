      ...
      <div style={{ maxWidth: '1100px', margin: '0 auto' }}>
        <div style={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'space-between', alignItems: 'center', gap: '24px' }}>
          ...
          <div style={{ display: 'flex', gap: '20px', alignItems: 'center' }}>
            ...
            <a href="#how-it-works" style={linkStyle} onMouseEnter={e => e.currentTarget.style.color = '#00D4FF'} onMouseLeave={e => e.currentTarget.style.color = 'rgba(255,255,255,0.3)'}>How It Works</a>
            <div style={{ width: '1px', height: '16px', background: 'rgba(255,255,255,0.08)' }} />
            {/* GitHub */}
            <a href="https://github.com/adirokxretero/resume-builder" target="_blank" rel="noreferrer" style={{ color: 'rgba(255,255,255,0.25)', transition: 'color 0.2s', display: 'flex' }} onMouseEnter={e => e.currentTarget.style.color = '#00D4FF'} onMouseLeave={e => e.currentTarget.style.color = 'rgba(255,255,255,0.25)'}>
